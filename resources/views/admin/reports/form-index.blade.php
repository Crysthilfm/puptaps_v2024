    ...
    <section class="mt-4 mt-sm-4 mt-md-4 mt-lg-5 mt-xl-5 mb-5">
        <div class="container-fluid box-content">
            ...
            <div class="row justify-content-center">
                ...
                {{-- ===================== New Generator ===================== --}}
            <div class="col-11">
                <div class="row sub-container-box mt-3 py-4 px-3">
                    {{-- <form action="{{ route('eifReports.generateEIFReport') }}" method="post" target="_blank" class="row"> --}}
                    <form action="{{ route('admin.eifReports') }}" method="post" target="_blank" class="row">
                    @csrf
                        <h3 class="mb-4 mt-3">EIF Reports<i class="fa-solid fa-file-lines ms-1"></i></h3>
                        <div class="col-4 mb-3">
                            <label class="form-label">Course</label>
                            <select class="form-select" name="course">
                                <option value="all" >All</option>
                                @foreach ($courses as $a)
                                <option value="{{ $a->course_id }}">{{ $a->course_id }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-4 mb-3">
                    ...
                    <form action="{{ route('admin.sasReports') }}" method="post" target="_blank" class="row">
                        @csrf
                            <h3 class="mb-4 mt-3">SAS Reports<i class="fa-solid fa-file-lines ms-1"></i></h3>
                            <div class="col-4 mb-3">
                                <label class="form-label">Course</label>
                                <select class="form-select" name="course">
                                    <option value="all" >All</option>
