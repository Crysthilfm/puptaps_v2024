              ...
              <div class="row g-0 w-100">
                  ...
                  <form action="/reports/printReports" id="hiddenForm" method="post" enctype="multipart/form-data" class="row" style="margin-top: 10%; width:100%; display:flex; justify-content:center;">
                    ...
                    <div style="display:flex; justify-content:center;">
                      <h4>After charts have loaded, please press the print button</h3><br><br><br>
                      <input type="hidden" name="chartData" id="chartInputData">
                      <input type="hidden" name="batch" value="{{$batch}}">
                      <input type="hidden" name="course" value="{{$course}}">
                      <input type="hidden" name="alumniCount" value="{{$alumniCount}}">
                      <input type="hidden" name="report_type" value="Student Affairs and Services">
                    </div>
...
// tables
        ...
        for(let questionIndex = 0; questionIndex<dataContent.length; questionIndex++){
          ...
          // Define headers
          if(questionIndex == 0){
            $("#draw-charts").append("<div> <h3>Student Affairs and Services (SAS) Program</h3>");
          }
          if(questionIndex == 22){
            $("#draw-charts").append("<hr style='height: 5px; background-color: black;'><h3><h3>Admission Services</h3>");
          }
          if(questionIndex == 26){
            $("#draw-charts").append("<hr style='height: 5px; background-color: black;'><h3>Information and Orientation Services</h3>");
          }
          if(questionIndex == 32){
            $("#draw-charts").append("<hr style='height: 5px; background-color: black;'><h3>Scholarship and Financial Assistance</h3>");
          }
          if(questionIndex == 36){
            $("#draw-charts").append("<hr style='height: 5px; background-color: black;'><h3>Health Services</h3>");
          }
          if(questionIndex == 42){
            $("#draw-charts").append("<hr style='height: 5px; background-color: black;'><h3>Guidance and Counseling Services</h3>");
          }
          if(questionIndex == 47){
            $("#draw-charts").append("<hr style='height: 5px; background-color: black;'><h3>Food Services</h3>");
          }
          if(questionIndex == 52){
            $("#draw-charts").append("<hr style='height: 5px; background-color: black;'><h3>Career and Placement Services</h3>");
          }
          if(questionIndex == 57){
            $("#draw-charts").append("<hr style='height: 5px; background-color: black;'><h3>Safety and Security Services</h3>");
          }
          if(questionIndex == 60){
            $("#draw-charts").append("<hr style='height: 5px; background-color: black;'><h3>Student Discipline</h3>");
          }
          if(questionIndex == 63){
            $("#draw-charts").append("<hr style='height: 5px; background-color: black;'><h3>Services for Students with Special Needs</h3>");
          }
          if(questionIndex == 66){
            $("#draw-charts").append("<hr style='height: 5px; background-color: black;'><h3>Student Organizations and Activities</h3>");
          }
          ...
          google.charts.load('current',{
            callback: function(){
              ...
              google.visualization.events.addListener(chart, 'ready', function(){
                ...
                // Define headers
                if(questionIndex == 0){
                  loadedCharts += "<div class='page-break'> <h3>Student Affairs and Services (SAS) Program</h3>";
                }
                if(questionIndex == 22){
                  loadedCharts += "<div class='page-break'></div><hr style='height: 5px; background-color: black;'><h3>Admission Services</h3>";
                }
                if(questionIndex == 26){
                  loadedCharts += "<div class='page-break'></div><hr style='height: 5px; background-color: black;'><h3>Information and Orientation Services</h3>";
                }
                if(questionIndex == 32){
                  loadedCharts += "<div class='page-break'></div><hr style='height: 5px; background-color: black;'><h3>Scholarship and Financial Assistance</h3>";
                }
                if(questionIndex == 36){
                  loadedCharts += "<div class='page-break'></div><hr style='height: 5px; background-color: black;'><h3>Health Services</h3>";
                }
                if(questionIndex == 42){
                  loadedCharts += "<div class='page-break'></div><hr style='height: 5px; background-color: black;'><h3>Guidance and Counseling Services</h3>";
                }
                if(questionIndex == 47){
                  loadedCharts += "<div class='page-break'></div><hr style='height: 5px; background-color: black;'><h3>Food Services</h3>";
                }
                if(questionIndex == 52){
                  loadedCharts += "<div class='page-break'></div><hr style='height: 5px; background-color: black;'><h3>Career and Placement Services</h3>";
                }
                if(questionIndex == 57){
                  loadedCharts += "<div class='page-break'></div><hr style='height: 5px; background-color: black;'><h3>Safety and Security Services</h3>";
                }
                if(questionIndex == 60){
                  loadedCharts += "<div class='page-break'></div><hr style='height: 5px; background-color: black;'><h3>Student Discipline</h3>";
                }
                if(questionIndex == 63){
                  loadedCharts += "<div class='page-break'></div><hr style='height: 5px; background-color: black;'><h3>Services for Students with Special Needs</h3>";
                }
                if(questionIndex == 66){
                  loadedCharts += "<div class='page-break'></div><hr style='height: 5px; background-color: black;'><h3>Student Organizations and Activities</h3>";
                }
