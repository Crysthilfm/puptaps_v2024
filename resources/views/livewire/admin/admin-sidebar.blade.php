<div class="container-fluid pt-3 pb-2 px-0 h-100 admin-sidebar position-fixed table-wrapper-scroll-y my-custom-scrollbar">
            ...
            <div class="w-100 sidebar-buttons">
                ...
                <div class="">
                    <div class="collapse show" id="tracerManagement">
                        {{-- <a type="button" href="{{ route('admin.homepage') }}" class="sidebar-button w-100 text-start py-2 @yield('active-homepage')">
