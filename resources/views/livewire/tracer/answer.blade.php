                                    ...
                                    <div class="form-group">
                                        @if (($value->question_type == "text") || ($value->question_type == "date"))
                                            <div>
                                                ...
                                                <input type="{{ $value->question_type }}" class="form-control @if ($arrayAnswers[$key]['answer'] == null) @error('arrayAnswers.' . $key . '.answer') is-invalid @enderror @else  @endif" wire:model="arrayAnswers.{{ $key }}.answer" @if ($no_board_exam == 'NO_BOARD_EXAM')disabled @endif>
